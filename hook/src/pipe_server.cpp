        ...
        if (cmd == "ping") {
            ...
            if (allow_queue_fallback && !result.success && result.error_code == 30) {
                ...
                resp["data"] = {
                    ...
                    {"arg1_ctx_written", result.arg1_ctx_written},
                    {"direct_ctx_available", result.direct_ctx_available},
                    {"direct_tls_override_enabled", result.direct_tls_override_enabled},
            ...
            resp["data"] = {
                ...
                {"arg1_template_ready", has_arg1_template()},
                {"arg1_ctx_patch_hits", get_arg1_ctx_patch_hits()},
                {"hook_hit_count", get_hook_hit_count()},
                {"hook_top_hit_count", get_hook_top_hit_count()},
                {"tls_accessor_hook_installed", is_tls_accessor_hook_installed()},
                {"arg1_ctx_helper_hook_installed", is_arg1_ctx_helper_hook_installed()},
                {"tls_accessor_addr", get_tls_accessor_addr()},
                {"arg1_ctx_helper_addr", get_arg1_ctx_helper_addr()},
                {"tls_accessor_hook_last_status", get_tls_accessor_hook_last_status()},
                {"arg1_ctx_helper_hook_last_status", get_arg1_ctx_helper_hook_last_status()},
